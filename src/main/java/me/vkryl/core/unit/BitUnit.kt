...
enum class BitUnit {
  ...
  @JvmOverloads
  fun convert(size: Double, unit: ByteUnit, wordSize: Int = java.lang.Byte.SIZE): Double {
    val bits = safeMulti(unit.toBytes(size).toDouble(), wordSize.toDouble())
  ...
  companion object {
    ...
    val C_KIBIT = 2.0.pow(10.0)
    val C_MIBIT = 2.0.pow(20.0)
    val C_GIBIT = 2.0.pow(30.0)
    val C_TIBIT = 2.0.pow(40.0)
    val C_PIBIT = 2.0.pow(50.0)
    val C_KBIT = 10.0.pow(3.0)
    val C_MBIT = 10.0.pow(6.0)
    val C_GBIT = 10.0.pow(9.0)
    val C_TBIT = 10.0.pow(12.0)
    val C_PBIT = 10.0.pow(15.0)
